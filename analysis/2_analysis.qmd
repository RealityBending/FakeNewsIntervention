...
estimate_contrasts(m1, contrast="Condition", by=c("Topic", "Nature", "Intervention"), p_adjust="holm")
estimate_contrasts(m1, contrast="Intervention", by=c("Topic", "Nature", "Condition='Pre-test'"), p_adjust="holm")
...
# # p_mist1 / p_mist2
# 
estimate_contrasts(m2, contrast="Condition", by=c("Topic", "Nature", "Intervention"), p_adjust="holm")
estimate_contrasts(m2, contrast="Intervention", by=c("Topic", "Nature", "Condition='Pre-test'"), p_adjust="holm")
```
...
estimate_contrasts(m3, contrast="Condition", by=c("Nature", "Intervention"), p_adjust="holm")
estimate_contrasts(m3, contrast="Intervention", by=c("Nature", "Condition='Pre-test'"), p_adjust="holm")
```
...
rez_ideology$p
filter(rez_ideology$trends, p < .05)

rez_ideology$p_conf
filter(rez_ideology$trends_conf, p < .05)
```
