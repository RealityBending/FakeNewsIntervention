...
# This will give you a wide format with one column per unique combination of Condition, RealFake, Topic, and QuestionID.
...
# Calculate confidence for each question (distance from 50)
df_wide <- df_wide %>%
...
# Save the result to a CSV for review
write.csv(df_wide, "df_wide_confidence_summary.csv", row.names = FALSE)
